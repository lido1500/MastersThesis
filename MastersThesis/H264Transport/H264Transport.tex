\chapter{Le transport de séquences H.264}
...
à la \sect{sect-tranche}, mais cette fois, dans l'optique du transport sur des
réseaux peu fiables. Par la suite, à la \sect{sect-dissimulation}, nous
...
flexible de macroblocs, à la \sect{sect-FMO}, ainsi que les ensembles de
paramètres, à la \sect{sect-ParameterSets}. Finalement, aux
...
\ang{raster}, comme illustré à la \fig{fig-Tranches}, où les 99 macroblocs d'une
...
aux données vidéo. Comme présenté à la \sect{sect-RTP} \page{sect-RTP}, chaque
...
a peu de variation entre les trames. La \fig{fig-FrameCopy} illustre un exemple
...
\begin{figure}
	\fbox{\centering 
		\tikzstyle{na} = [Baseline=-.5ex] \tikzstyle{every picture}+=[remember picture] 
	...
	\caption[Visualisation du calque d'une tranche]{Visualisation du calque d'une
	tranche.}
	\label{fig-FrameCopy}
\end{figure}
...
\begin{figure}
	...
	\caption[Visualisation du calque des vecteurs de mouvement]{Visualisation du
calque des vecteurs de mouvement.}
...
meilleur contrôle sur la répartition des macroblocs dans les tranches de sorte à
mieux disperser les pertes à travers l'image et, ainsi, à augmenter l'efficacité
de la dissimulation.

La \fig{fig-Tranches} \page{fig-Tranches} montre l'ordonnancement typique d'une
séquence H.264. Il existe plusieurs types d'ordonnancements flexibles. À titre
d'exemple, nous présentons aux figures~\ref{fig-Dispersed} et
\ref{fig-Interleaved} les ordonnancements de macroblocs dispersé et entrelacé.
Tous deux illustrent la répartition des macroblocs d'une trame séparée en deux
tranches.
...
\begin{figure}
	...
	\minibox[c]{
			...
			\subfloat{ \small
				\import{H264Transport/images/}{FMOLegend.pdf_tex}
			}
		}
	}
...
\begin{figure}
	\fbox{\centering
		...
		\subfloat[Détérioration visuelle (amplifiée)]{
...
d'images. Ceux-ci sont présentés à la \fig{fig-ParameterSet}.
...
H.264 \page{chap-h264}. La couche d'abstraction réseau \ang{Network Abstraction
...
illustré à la \fig{fig-OSI_Layers}. De plus, à la \fig{fig-IPUDPRTP}, nous
...
\begin{figure}
	\fbox{ \centering
		\includegraphics[width=0.97\linewidth]{images/IPUDPRTP.pdf}
...
Ce chapitre sur le transport de séquences H.264, regroupe un grand nombre de
