...
\newcommand{\ltDiffBad}{\left| \ltE{x,y} - \ltP{x,y} \right|}
...
Les approches de détection de la détérioration visuelle étudiées ici sont
...
n'est pas en mesure d'identifier l'erreur.
...
\begin{figure}
\fbox{
\includegraphics{images/MCBExplained.pdf}
}
...
visuelle. \SC{Phrase bizarre. Revoir à l'aptitude dissimulation de la détérioration} En effectuant une dissimulation seulement lorsque du contenu de
qualité supérieure (jugée par le SDMCB) est disponible.\SC{Phrase bizarre. Revoir le français de la phrase.} 
...
\SC{à l'échel?}\label{sect-SelectiveTrame}
